...
public class BookingService {
    ...
    public BookingService(BookingRepository b_repo, GoogleMapsService gms, WarehouseRepository w_repo) {
        this.b_repo = b_repo;
    ...
    public Booking createBooking(Booking booking) {
        if (booking.getWarehouse() == null) throw new IllegalArgumentException("Warehouse cannot be null");
        ...
        if (booking.getToAddress() == null || booking.getToAddress().isEmpty()) throw new IllegalArgumentException("Booking must have a valid toAddress");
